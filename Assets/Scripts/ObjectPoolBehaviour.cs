...
namespace ObjectPool
{
    public class ObjectPoolBehaviour : MonoBehaviour
    {
        ...
        public void ReturnObject(GameObject objectInstance)
        {
            ...
            //If a pool for this object type doesn't exist...
            if (objectPool == null)
            {
                //...create a new pool for the object.
        ...
        /// </summary>
        /// <param name="objectReference">A reference to the prefab to instantiate</param>
        /// <param name="position">The new world position of the object</param>
        /// <param name="rotation">The new world rotation of the object</param>
